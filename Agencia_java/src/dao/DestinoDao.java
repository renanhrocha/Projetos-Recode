...
public class DestinoDao {
	...
	public void save(Destino destino) {
		...
		String sql = "INSERT INTO destino (data_destino, id_destino, local_destino, valor_destino )" + " VALUES(?,?,?,?)";
		...
		try {
			...
			pstm.setInt(4, destino.getValor_destino());
	...
	public void update(Destino destino) {
		String sql = "UPDATE destino SET data_destino = ?, local_destino = ?, valor_destino = ?" + "WHERE id_destino = ?";
		...
		try {
			...
			// adiciona o terceiro valor do parametro da sql
			pstm.setInt(3, destino.getValor_destino());
			// adiciona o id
